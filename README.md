# superSquad-react-redux
  ...
  The following shows the connect function breakdown: 
    1. mapStateToProps
        You will see shortly that some of these parameters can be a function or an object. However, mapStateToProps needs to be a function. This function does exactly what the name suggests, connect state from the store to corresponding props. 
    ...
    3. mergeProps — optional
        it is an optional parameter and is a function. The documentation on this particular function does not explain much as to it’s purpose and use cases.
    4. options — optional
...
export default App;
```
>>>>>>> 3bcdeac70fa8056d15463a572ef741ffa16773e2
